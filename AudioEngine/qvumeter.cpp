...
void QVUMeter::paintBorder()
{
    ...
    painter.drawText(Left, Qt::AlignCenter, "Peak");
    painter.drawText(Right, Qt::AlignCenter, "Rms");
}
...
void QVUMeter::paintValue()
{
    ...
    QString lVal = QString("%1").arg(leftVal, 0,'f', 3);
    painter.drawText(leftR, Qt::AlignCenter, lVal);
    QRectF rightR(55, 15, 25, 25);
    QString rVal = QString("%1").arg(rightVal, 0,'f', 3);
